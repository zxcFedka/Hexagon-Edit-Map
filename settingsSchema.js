...
const settingsSchema = [
    ...
    { name: "visible", type: "boolean", defaultValue: true, luaName: "visible" },
    { name: "Previous Map", type: "boolean", defaultValue: true, luaName: "PreviousMap" },
    { name: "Next Map", type: "boolean", defaultValue: true, luaName: "NextMap" }
